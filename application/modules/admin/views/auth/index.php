                ...
                <div class="p-5">
                  <div class="text-center">
                    <div class="col-md-8 m-auto">
                      <img src="<?= base_url('assets/backend/img/') ?>kucing_logo.png" alt="logo kucing" class="img-fluid mb-6"><br>
                    </div>
                    <div class="alert alert-success" role="alert">
                     <strong>Hallo PetCare, anda berada pada halaman login admin. jangan lupa logout setelah menggunakan sistem :)</strong>
                    </div>
                  </div>
                  <?= $this->session->flashdata('message'); ?>
                  <form class="user" action="<?= base_url('admin/auth'); ?>" method="post">
                    <div class="form-group">
                      <input type="text" name="email" required class="form-control form-control-user" placeholder="Enter email">
                    </div>
                    <div class="form-group">
