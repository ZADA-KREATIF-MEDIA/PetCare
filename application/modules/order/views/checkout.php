                    ...
                    <div class="col-12">
                        <div class="card mb-3 row">
                            ...
                            <div class="card-body row mx-0">
                                <div class="col-12 mb-2">
                                    <span class="badge badge-primary p-2" id="jenisPelayanan">Pengambilan dan Pengantaran</span>
                                    <div class="dropdown float-right <?php if($jumlah_layanan > 0){ echo "d-none"; } ?>">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <a class="dropdown-item" href="#" onclick="servicePengantaran()">Pengantaran</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6 mb-3" id="bagianAlamatPengambilan">
                                ...
                                <div class="col-sm-12 col-md-6" id="bagianAlamatPengantaran">
                        ...
                        <div class="card mt-3">
                            <ul class="list-group list-group-flush">
                                ...
                                <?php else: ?>
                                    <li class="list-group-item" id="bagianHargaPengambilan">
                        ...
                        <input type="hidden" id="jenisPelayananSimpan" name="jenis_pelayanan"> 
